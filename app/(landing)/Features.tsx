  ...
  return (
    <div className="space-y-[45px] xl:space-y-[55px] w-full xl:w-[430px]">
      <Feature
        description={
          <>
            <span className="font-bold not-italic">DUST</span> is an autonomous world with fixed rules of physics. Program civilization, contest for scarce matter, and grow permanent history.
          </>
        }
      />
