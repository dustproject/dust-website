      ...
      <body className="font-sans bg-black h-full w-full">
        ...
        <main className="relative pt-[150px] pb-[140px] lg:py-[200px] px-6 overflow-hidden min-h-full xl:h-screen xl:flex xl:items-center xl:justify-center">
          <Image
            ...
            width={1000}
            height={1000}
            className="absolute top-0 -translate-y-1/2 left-1/2 -translate-x-1/2 w-full px-3 md:w-3/4 xl:w-3/5"
          />
          <Image
            src="/DUST.png"
            alt="DUST"
            width={1000}
            height={1000}
            className="absolute bottom-0 translate-y-1/2 left-1/2 -translate-x-1/2 w-full px-3 md:w-3/4 xl:w-3/5"
          />
